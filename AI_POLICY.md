...
The Plumber project has strict rules for AI usage:
...
- **Bad AI drivers will be banned** You've been warned. We love to help junior
  ...
  AI, and we'll help you.  We are sorry that bad AI drivers have ruined this
  for you.

These rules apply only to outside contributions to Plumber. Maintainers
...
Please remember that Plumber is maintained by humans.
...
Plumber is written with plenty of AI assistance, and many maintainers embrace
